...
#Region "主処理"
    ...
    Private Sub SUB_VIEW_DIALOG_USER_COMP()
        ...
        If Not WPF_SHOW.CANCEL Then
            ...
            CMB_TRIM_COMPOTION_TYPE_USER.Items(INT_INDEX - 1) = SRT_USER_SET(INT_INDEX).NAME
            CMB_TRIM_COMPOTION_TYPE_USER.SelectedIndex = (INT_INDEX - 1)
        End If
...
#Region "設定←→画面コントロール"
    Private Sub SUB_SET_SETTING_TO_CONTROL(ByRef SRT_SET As SRT_APP_SETTINGS)
        ...
        End With
        With SRT_SET.CAMERA
            CHK_CAMERA_CONTROL_WAIT_RESPONSE.IsChecked = FUNC_CAST_INT_TO_BOOL(.CONTROL.WAIT_FOR_GAME_RESPONSE)
            TXT_CAMERA_CONTROL_WASD_PUSH_WAIT.Text = .CONTROL.WASD_PUSH_WEIGHT
            TXT_CAMERA_CONTROL_ARROW_PUSH_WAIT.Text = .CONTROL.ARROW_PUSH_WEIGHT
            TXT_CAMERA_CONTROL_PAGE_UD_PUSH_WAIT.Text = .CONTROL.PAGEUD_PUSH_WEIGHT
        End With
    End Sub
    ...
    Private Function FUNC_GET_SETTING_FROM_CONTROL()
        ...
        With SRT_RET.TRIM
            ...
            .COMPOTION.TYPE = (CMB_TRIM_COMPOTION_TYPE.SelectedIndex + 1)
        ...
        End With
        With SRT_RET.CAMERA
            .CONTROL.WAIT_FOR_GAME_RESPONSE = FUNC_CAST_BOOL_TO_INT(CHK_CAMERA_CONTROL_WAIT_RESPONSE.IsChecked)
            .CONTROL.WASD_PUSH_WEIGHT = FUNC_VALUE_CONVERT_NUMERIC_INT(TXT_CAMERA_CONTROL_WASD_PUSH_WAIT.Text, 50)
            .CONTROL.ARROW_PUSH_WEIGHT = FUNC_VALUE_CONVERT_NUMERIC_INT(TXT_CAMERA_CONTROL_ARROW_PUSH_WAIT.Text, 50)
            .CONTROL.PAGEUD_PUSH_WEIGHT = FUNC_VALUE_CONVERT_NUMERIC_INT(TXT_CAMERA_CONTROL_PAGE_UD_PUSH_WAIT.Text, 50)
        End With
        Return SRT_RET
    End Function
#End Region
