...
#Region "画面用・列挙定数"
    ...
    Private Enum ENM_DIVISION_PATTERN
        ...
        GOLDEN_RECTANGLE_HLL = 11
        GOLDEN_RECTANGLE_HUR = 12
        GOLDEN_RECTANGLE_HUL = 13
        GOLDEN_RECTANGLE_HLR = 14

        GOLDEN_RECTANGLE_VLL = 21
        GOLDEN_RECTANGLE_VUR = 22
        GOLDEN_RECTANGLE_VUL = 23
        GOLDEN_RECTANGLE_VLR = 24
    End Enum
